...
//!	
//!		CHANGELOG:
//!			v1.0.1 -> Added header guard, modified a few other comments.
//!			v1.0.2 -> Moved documentation into .h file. Added C++ header guard.
//!				Added detail comments to some functions. Removed '_' prefix from
//!				header guard ID (restricted namespace).
//!		
